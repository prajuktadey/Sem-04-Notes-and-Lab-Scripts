...
ALTER TABLE DEPOSIT_21052263 MODIFY ACTNO INT NOT NULL UNIQUE;
ALTER TABLE DEPOSIT_21052263 MODIFY ACTNO INT DEFAULT 0;

TRUNCATE TABLE DEPOSIT_21052263;
ALTER TABLE DEPOSIT_21052263 ADD CONSTRAINT B1 CHECK (ACTNO>100);

ALTER TABLE DEPOSIT_21052263 DROP CONSTRAINT B1;
ALTER TABLE DEPOSIT_21052263 DROP CONSTRAINT A1;
